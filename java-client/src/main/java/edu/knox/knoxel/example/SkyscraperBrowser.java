...
public class SkyscraperBrowser {
    public static void main(String[] args)
    throws Exception
    {
        String email = "test@email.com";
        String programName = "skyscraper";
        String description = "Building a skyscraper";
        ...
        // opens in the browser using the static site
        // THIS DOES NOT SAVE YOUR SUBMISSION FOR YOUR INSTRUCTOR
